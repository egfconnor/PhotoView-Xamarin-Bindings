...
namespace UK.CO.Senab.Photoview.Gestures {
	...
	public partial class CupcakeGestureDetector : global::Java.Lang.Object, global::UK.CO.Senab.Photoview.Gestures.IGestureDetector {
		...
		public CupcakeGestureDetector (global::Android.Content.Context p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning restore 0169
		...
		public virtual void SetOnGestureListener (global::UK.CO.Senab.Photoview.Gestures.IOnGestureListener p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setOnGestureListener", "(Luk/co/senab/photoview/gestures/OnGestureListener;)V"), new JValue (p0));
		}
