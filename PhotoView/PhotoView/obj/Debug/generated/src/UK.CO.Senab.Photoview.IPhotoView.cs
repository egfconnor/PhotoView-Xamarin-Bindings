...
namespace UK.CO.Senab.Photoview {
	...
	public abstract class PhotoView {
	...
	[System.Obsolete ("Use the 'PhotoView' type. This type will be removed in Mono for Android 5.0.")]
	public abstract class PhotoViewConsts : PhotoView {

		private PhotoViewConsts ()
		{
		}
	}

	// Metadata.xml XPath interface reference: path="/api/package[@name='uk.co.senab.photoview']/interface[@name='IPhotoView']"
	[Register ("uk/co/senab/photoview/IPhotoView", "", "UK.CO.Senab.Photoview.IPhotoViewInvoker")]
	public partial interface IPhotoView : IJavaObject {
		...
		global::Android.Graphics.Matrix DisplayMatrix {
			...
			[Register ("getDisplayMatrix", "()Landroid/graphics/Matrix;", "GetGetDisplayMatrixHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
		}
		...
		global::Android.Graphics.RectF DisplayRect {
			...
			[Register ("getDisplayRect", "()Landroid/graphics/RectF;", "GetGetDisplayRectHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
		}

		global::UK.CO.Senab.Photoview.IPhotoView IPhotoViewImplementation {
			...
			[Register ("getIPhotoViewImplementation", "()Luk/co/senab/photoview/IPhotoView;", "GetGetIPhotoViewImplementationHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
		}
		...
		float MaxScale {
			...
			[Register ("getMaxScale", "()F", "GetGetMaxScaleHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setMaxScale", "(F)V", "GetSetMaxScale_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		float MaximumScale {
			...
			[Register ("getMaximumScale", "()F", "GetGetMaximumScaleHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setMaximumScale", "(F)V", "GetSetMaximumScale_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		float MediumScale {
			...
			[Register ("getMediumScale", "()F", "GetGetMediumScaleHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setMediumScale", "(F)V", "GetSetMediumScale_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		float MidScale {
			...
			[Register ("getMidScale", "()F", "GetGetMidScaleHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setMidScale", "(F)V", "GetSetMidScale_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		float MinScale {
			...
			[Register ("getMinScale", "()F", "GetGetMinScaleHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setMinScale", "(F)V", "GetSetMinScale_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		float MinimumScale {
			...
			[Register ("getMinimumScale", "()F", "GetGetMinimumScaleHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setMinimumScale", "(F)V", "GetSetMinimumScale_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		global::UK.CO.Senab.Photoview.PhotoViewAttacher.IOnPhotoTapListener OnPhotoTapListener {
			...
			[Register ("getOnPhotoTapListener", "()Luk/co/senab/photoview/PhotoViewAttacher$OnPhotoTapListener;", "GetGetOnPhotoTapListenerHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setOnPhotoTapListener", "(Luk/co/senab/photoview/PhotoViewAttacher$OnPhotoTapListener;)V", "GetSetOnPhotoTapListener_Luk_co_senab_photoview_PhotoViewAttacher_OnPhotoTapListener_Handler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		global::UK.CO.Senab.Photoview.PhotoViewAttacher.IOnViewTapListener OnViewTapListener {
			...
			[Register ("getOnViewTapListener", "()Luk/co/senab/photoview/PhotoViewAttacher$OnViewTapListener;", "GetGetOnViewTapListenerHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setOnViewTapListener", "(Luk/co/senab/photoview/PhotoViewAttacher$OnViewTapListener;)V", "GetSetOnViewTapListener_Luk_co_senab_photoview_PhotoViewAttacher_OnViewTapListener_Handler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		float Scale {
			...
			[Register ("getScale", "()F", "GetGetScaleHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setScale", "(F)V", "GetSetScale_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		global::Android.Widget.ImageView.ScaleType ScaleType {
			...
			[Register ("getScaleType", "()Landroid/widget/ImageView$ScaleType;", "GetGetScaleTypeHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
			...
			[Register ("setScaleType", "(Landroid/widget/ImageView$ScaleType;)V", "GetSetScaleType_Landroid_widget_ImageView_ScaleType_Handler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] set;
		}
		...
		global::Android.Graphics.Bitmap VisibleRectangleBitmap {
			...
			[Register ("getVisibleRectangleBitmap", "()Landroid/graphics/Bitmap;", "GetGetVisibleRectangleBitmapHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")] get;
		}
		...
		[Register ("canZoom", "()Z", "GetCanZoomHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		bool CanZoom ();
		...
		[Register ("setAllowParentInterceptOnEdge", "(Z)V", "GetSetAllowParentInterceptOnEdge_ZHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setDisplayMatrix", "(Landroid/graphics/Matrix;)Z", "GetSetDisplayMatrix_Landroid_graphics_Matrix_Handler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setOnDoubleTapListener", "(Landroid/view/GestureDetector$OnDoubleTapListener;)V", "GetSetOnDoubleTapListener_Landroid_view_GestureDetector_OnDoubleTapListener_Handler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setOnLongClickListener", "(Landroid/view/View$OnLongClickListener;)V", "GetSetOnLongClickListener_Landroid_view_View_OnLongClickListener_Handler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setOnMatrixChangeListener", "(Luk/co/senab/photoview/PhotoViewAttacher$OnMatrixChangedListener;)V", "GetSetOnMatrixChangeListener_Luk_co_senab_photoview_PhotoViewAttacher_OnMatrixChangedListener_Handler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setPhotoViewRotation", "(F)V", "GetSetPhotoViewRotation_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setRotationBy", "(F)V", "GetSetRotationBy_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setRotationTo", "(F)V", "GetSetRotationTo_FHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setScale", "(FZ)V", "GetSetScale_FZHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setScale", "(FFFZ)V", "GetSetScale_FFFZHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setZoomTransitionDuration", "(I)V", "GetSetZoomTransitionDuration_IHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		...
		[Register ("setZoomable", "(Z)V", "GetSetZoomable_ZHandler:UK.CO.Senab.Photoview.IPhotoViewInvoker, PhotoView")]
		void SetZoomable (bool p0);

	}

	[global::Android.Runtime.Register ("uk/co/senab/photoview/IPhotoView", DoNotGenerateAcw=true)]
	internal class IPhotoViewInvoker : global::Java.Lang.Object, IPhotoView {

		static IntPtr java_class_ref = JNIEnv.FindClass ("uk/co/senab/photoview/IPhotoView");
		IntPtr class_ref;

		public static IPhotoView GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IPhotoView> (handle, transfer);
		}
		...
		public IPhotoViewInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
		...
		protected override System.Type ThresholdType {
			get { return typeof (IPhotoViewInvoker); }
		}
...
#pragma warning disable 0169
		...
		{
			global::UK.CO.Senab.Photoview.IPhotoView __this = global::Java.Lang.Object.GetObject<global::UK.CO.Senab.Photoview.IPhotoView> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.DisplayMatrix);
		}
#pragma warning restore 0169

		IntPtr id_getDisplayMatrix;
		public global::Android.Graphics.Matrix DisplayMatrix {
			get {
...
#pragma warning restore 0169
		...
		public global::Android.Graphics.RectF DisplayRect {
			get {
...
#pragma warning restore 0169
		...
		public global::UK.CO.Senab.Photoview.IPhotoView IPhotoViewImplementation {
			get {
				...
				return global::Java.Lang.Object.GetObject<global::UK.CO.Senab.Photoview.IPhotoView> (JNIEnv.CallObjectMethod (Handle, id_getIPhotoViewImplementation), JniHandleOwnership.TransferLocalRef);
			}
		}
...
#pragma warning restore 0169
		...
		public global::UK.CO.Senab.Photoview.PhotoViewAttacher.IOnPhotoTapListener OnPhotoTapListener {
			get {
			...
			set {
				...
				JNIEnv.CallVoidMethod (Handle, id_setOnPhotoTapListener_Luk_co_senab_photoview_PhotoViewAttacher_OnPhotoTapListener_, new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public global::UK.CO.Senab.Photoview.PhotoViewAttacher.IOnViewTapListener OnViewTapListener {
			get {
			...
			set {
				...
				JNIEnv.CallVoidMethod (Handle, id_setOnViewTapListener_Luk_co_senab_photoview_PhotoViewAttacher_OnViewTapListener_, new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public global::Android.Widget.ImageView.ScaleType ScaleType {
			...
			set {
				...
				JNIEnv.CallVoidMethod (Handle, id_setScaleType_Landroid_widget_ImageView_ScaleType_, new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public global::Android.Graphics.Bitmap VisibleRectangleBitmap {
			get {
...
#pragma warning restore 0169
		...
		public void SetAllowParentInterceptOnEdge (bool p0)
		{
...
#pragma warning restore 0169
		...
		public bool SetDisplayMatrix (global::Android.Graphics.Matrix p0)
		{
			...
			bool __ret = JNIEnv.CallBooleanMethod (Handle, id_setDisplayMatrix_Landroid_graphics_Matrix_, new JValue (p0));
			return __ret;
		}
...
#pragma warning restore 0169
		...
		public void SetOnDoubleTapListener (global::Android.Views.GestureDetector.IOnDoubleTapListener p0)
		{
...
#pragma warning restore 0169
		...
		public void SetOnLongClickListener (global::Android.Views.View.IOnLongClickListener p0)
		{
			...
			JNIEnv.CallVoidMethod (Handle, id_setOnLongClickListener_Landroid_view_View_OnLongClickListener_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public void SetOnMatrixChangeListener (global::UK.CO.Senab.Photoview.PhotoViewAttacher.IOnMatrixChangedListener p0)
		{
			...
			JNIEnv.CallVoidMethod (Handle, id_setOnMatrixChangeListener_Luk_co_senab_photoview_PhotoViewAttacher_OnMatrixChangedListener_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public void SetPhotoViewRotation (float p0)
		{
...
#pragma warning restore 0169
		...
		public void SetRotationBy (float p0)
		{
...
#pragma warning restore 0169
		...
		public void SetRotationTo (float p0)
		{
...
#pragma warning restore 0169
		...
		public void SetScale (float p0, bool p1)
		{
...
#pragma warning restore 0169
		...
		public void SetScale (float p0, float p1, float p2, bool p3)
		{
...
#pragma warning restore 0169
		...
		public void SetZoomTransitionDuration (int p0)
		{
...
#pragma warning restore 0169
		...
		public void SetZoomable (bool p0)
		{
