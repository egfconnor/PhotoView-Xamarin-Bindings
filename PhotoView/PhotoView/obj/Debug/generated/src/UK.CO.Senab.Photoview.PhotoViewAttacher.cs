...
namespace UK.CO.Senab.Photoview {
	...
	public partial class PhotoViewAttacher : global::Java.Lang.Object, global::Android.Views.View.IOnTouchListener, global::Android.Views.ViewTreeObserver.IOnGlobalLayoutListener, global::UK.CO.Senab.Photoview.IPhotoView, global::UK.CO.Senab.Photoview.Gestures.IOnGestureListener {
		...
		public partial class AnimatedZoomRunnable : global::Java.Lang.Object, global::Java.Lang.IRunnable {
			...
			public AnimatedZoomRunnable (global::UK.CO.Senab.Photoview.PhotoViewAttacher __self, float p1, float p2, float p3, float p4) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				if (GetType () != typeof (AnimatedZoomRunnable)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(L" + global::Android.Runtime.JNIEnv.GetJniName (GetType ().DeclaringType) + ";FFFF)V", new JValue (__self), new JValue (p1), new JValue (p2), new JValue (p3), new JValue (p4)),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(L" + global::Android.Runtime.JNIEnv.GetJniName (GetType ().DeclaringType) + ";FFFF)V", new JValue (__self), new JValue (p1), new JValue (p2), new JValue (p3), new JValue (p4));
					return;
				}
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Luk_co_senab_photoview_PhotoViewAttacher_FFFF, new JValue (__self), new JValue (p1), new JValue (p2), new JValue (p3), new JValue (p4)),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Luk_co_senab_photoview_PhotoViewAttacher_FFFF, new JValue (__self), new JValue (p1), new JValue (p2), new JValue (p3), new JValue (p4));
			}
...
#pragma warning restore 0169
		...
		public partial class FlingRunnable : global::Java.Lang.Object, global::Java.Lang.IRunnable {
			...
			public FlingRunnable (global::UK.CO.Senab.Photoview.PhotoViewAttacher __self, global::Android.Content.Context p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (Handle != IntPtr.Zero)
					return;
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Luk_co_senab_photoview_PhotoViewAttacher_Landroid_content_Context_, new JValue (__self), new JValue (p1)),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Luk_co_senab_photoview_PhotoViewAttacher_Landroid_content_Context_, new JValue (__self), new JValue (p1));
			}
...
#pragma warning restore 0169
			...
			public virtual void CancelFling ()
			{
...
#pragma warning restore 0169
			...
			public virtual void Fling (int p0, int p1, int p2, int p3)
			{
				if (id_fling_IIII == IntPtr.Zero)
					id_fling_IIII = JNIEnv.GetMethodID (class_ref, "fling", "(IIII)V");

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_fling_IIII, new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "fling", "(IIII)V"), new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
			}
...
#pragma warning restore 0169
		...
		public partial interface IOnMatrixChangedListener : IJavaObject {
			...
			[Register ("onMatrixChanged", "(Landroid/graphics/RectF;)V", "GetOnMatrixChanged_Landroid_graphics_RectF_Handler:UK.CO.Senab.Photoview.PhotoViewAttacher/IOnMatrixChangedListenerInvoker, PhotoView")]
...
#pragma warning restore 0169
			...
			public void OnMatrixChanged (global::Android.Graphics.RectF p0)
			{
				...
				JNIEnv.CallVoidMethod (Handle, id_onMatrixChanged_Landroid_graphics_RectF_, new JValue (p0));
			}
		...
		internal sealed class IOnMatrixChangedListenerImplementor : global::Java.Lang.Object, IOnMatrixChangedListener {
...
#pragma warning restore 0649
		...
		public partial interface IOnPhotoTapListener : IJavaObject {
			...
			[Register ("onPhotoTap", "(Landroid/view/View;FF)V", "GetOnPhotoTap_Landroid_view_View_FFHandler:UK.CO.Senab.Photoview.PhotoViewAttacher/IOnPhotoTapListenerInvoker, PhotoView")]
...
#pragma warning restore 0169
			...
			public void OnPhotoTap (global::Android.Views.View p0, float p1, float p2)
			{
				...
				JNIEnv.CallVoidMethod (Handle, id_onPhotoTap_Landroid_view_View_FF, new JValue (p0), new JValue (p1), new JValue (p2));
			}
		...
		internal sealed class IOnPhotoTapListenerImplementor : global::Java.Lang.Object, IOnPhotoTapListener {
...
#pragma warning restore 0649
		...
		public partial interface IOnViewTapListener : IJavaObject {
			...
			[Register ("onViewTap", "(Landroid/view/View;FF)V", "GetOnViewTap_Landroid_view_View_FFHandler:UK.CO.Senab.Photoview.PhotoViewAttacher/IOnViewTapListenerInvoker, PhotoView")]
...
#pragma warning restore 0169
			...
			public void OnViewTap (global::Android.Views.View p0, float p1, float p2)
			{
				...
				JNIEnv.CallVoidMethod (Handle, id_onViewTap_Landroid_view_View_FF, new JValue (p0), new JValue (p1), new JValue (p2));
			}
		...
		internal sealed class IOnViewTapListenerImplementor : global::Java.Lang.Object, IOnViewTapListener {
...
#pragma warning restore 0649
		...
		public PhotoViewAttacher (global::Android.Widget.ImageView p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			if (GetType () != typeof (PhotoViewAttacher)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/widget/ImageView;)V", new JValue (p0)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Landroid/widget/ImageView;)V", new JValue (p0));
				return;
			}
			...
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_widget_ImageView_, new JValue (p0)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Landroid_widget_ImageView_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual global::Android.Graphics.Matrix DrawMatrix {
...
#pragma warning restore 0169
		...
		public virtual global::UK.CO.Senab.Photoview.IPhotoView IPhotoViewImplementation {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return global::Java.Lang.Object.GetObject<global::UK.CO.Senab.Photoview.IPhotoView> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getIPhotoViewImplementation", "()Luk/co/senab/photoview/IPhotoView;")), JniHandleOwnership.TransferLocalRef);
			}
		}
...
#pragma warning restore 0169
		...
		public virtual global::Android.Widget.ImageView ImageView {
...
#pragma warning restore 0169
		...
		public virtual global::UK.CO.Senab.Photoview.PhotoViewAttacher.IOnPhotoTapListener OnPhotoTapListener {
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setOnPhotoTapListener", "(Luk/co/senab/photoview/PhotoViewAttacher$OnPhotoTapListener;)V"), new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual global::UK.CO.Senab.Photoview.PhotoViewAttacher.IOnViewTapListener OnViewTapListener {
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setOnViewTapListener", "(Luk/co/senab/photoview/PhotoViewAttacher$OnViewTapListener;)V"), new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual global::Android.Widget.ImageView.ScaleType ScaleType {
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setScaleType", "(Landroid/widget/ImageView$ScaleType;)V"), new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual void OnDrag (float p0, float p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onDrag", "(FF)V"), new JValue (p0), new JValue (p1));
		}
...
#pragma warning restore 0169
		...
		public virtual void OnFling (float p0, float p1, float p2, float p3)
		{
			if (id_onFling_FFFF == IntPtr.Zero)
				id_onFling_FFFF = JNIEnv.GetMethodID (class_ref, "onFling", "(FFFF)V");

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_onFling_FFFF, new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onFling", "(FFFF)V"), new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
		}
...
#pragma warning restore 0169
		...
		public virtual void OnScale (float p0, float p1, float p2)
		{
			if (id_onScale_FFF == IntPtr.Zero)
				id_onScale_FFF = JNIEnv.GetMethodID (class_ref, "onScale", "(FFF)V");

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_onScale_FFF, new JValue (p0), new JValue (p1), new JValue (p2));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onScale", "(FFF)V"), new JValue (p0), new JValue (p1), new JValue (p2));
		}
...
#pragma warning restore 0169
		...
		public virtual void SetOnLongClickListener (global::Android.Views.View.IOnLongClickListener p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setOnLongClickListener", "(Landroid/view/View$OnLongClickListener;)V"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void SetOnMatrixChangeListener (global::UK.CO.Senab.Photoview.PhotoViewAttacher.IOnMatrixChangedListener p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setOnMatrixChangeListener", "(Luk/co/senab/photoview/PhotoViewAttacher$OnMatrixChangedListener;)V"), new JValue (p0));
		}
