...
namespace UK.CO.Senab.Photoview {
	...
	public partial class Compat : global::Java.Lang.Object {
		...
		[Register (".ctor", "()V", "")]
		public Compat () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public static int GetPointerIndex (int p0)
		{
			if (id_getPointerIndex_I == IntPtr.Zero)
				id_getPointerIndex_I = JNIEnv.GetStaticMethodID (class_ref, "getPointerIndex", "(I)I");
			return JNIEnv.CallStaticIntMethod  (class_ref, id_getPointerIndex_I, new JValue (p0));
		}
		...
		public static void PostOnAnimation (global::Android.Views.View p0, global::Java.Lang.IRunnable p1)
		{
			...
			JNIEnv.CallStaticVoidMethod  (class_ref, id_postOnAnimation_Landroid_view_View_Ljava_lang_Runnable_, new JValue (p0), new JValue (p1));
		}
