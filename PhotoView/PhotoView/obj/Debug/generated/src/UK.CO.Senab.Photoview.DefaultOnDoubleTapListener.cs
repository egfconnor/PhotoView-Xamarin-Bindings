...
namespace UK.CO.Senab.Photoview {
	...
	public partial class DefaultOnDoubleTapListener : global::Java.Lang.Object, global::Android.Views.GestureDetector.IOnDoubleTapListener {
		...
		public DefaultOnDoubleTapListener (global::UK.CO.Senab.Photoview.PhotoViewAttacher p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (DefaultOnDoubleTapListener)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Luk/co/senab/photoview/PhotoViewAttacher;)V", new JValue (p0)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Luk/co/senab/photoview/PhotoViewAttacher;)V", new JValue (p0));
				return;
			}
			...
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Luk_co_senab_photoview_PhotoViewAttacher_, new JValue (p0)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Luk_co_senab_photoview_PhotoViewAttacher_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void SetPhotoViewAttacher (global::UK.CO.Senab.Photoview.PhotoViewAttacher p0)
		{
			...
			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_setPhotoViewAttacher_Luk_co_senab_photoview_PhotoViewAttacher_, new JValue (p0));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setPhotoViewAttacher", "(Luk/co/senab/photoview/PhotoViewAttacher;)V"), new JValue (p0));
		}
